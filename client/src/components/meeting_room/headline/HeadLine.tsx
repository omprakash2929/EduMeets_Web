		...
		<div className="flex grow items-center justify-between">
			{meetingData && (
				<>
					...
					<div className="flex items-center justify-between lg:justify-start flex-1 lg:flex-none  space-x-4">
						...
						<CommonButton
							...
							extraClass="hidden sm:block relative h-9 px-4 text-xs rounded-3xl "
						/>
					</div>
				</>
			)}
