	...
	return (
		<div className="w-full flex justify-center items-center">
			<form className={`w-fit mb-8 p-8 `} onSubmit={submitHandler}>
				...
				<div
					className={`w-full flex flex-col-reverse md:flex-row md:border-b ${
						theme === "dark" ? " border-transparent-400" : "border-gray-800 "
					}`}
				>
					<DateSelector selectedDate={selectedDate} selectDateHandler={selectDateHandler} />
					<div className="w-full md:w-fit md:pl-8 pb-4">
						<div
						...
						>
							...
							<div className="w-full flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:justify-between mt-4">
								<CheckboxButton
