	...
	try {
		...
		switch (action) {
			case "join_meeting":
				...
				break;
			case "leave_meeting":
				if (stats.attendances.length === 0) return;
			...
			case "audio_unmuted":
				...
				break;
			case "audio_muted":
				if (stats.audio_muted.length === 0) return;
			...
			case "video_unmuted":
				...
				break;
			case "video_muted":
				if (stats.video_muted.length === 0) return;
			...
			case "start_sharing":
				...
				break;
			case "stop_sharing":
				if (stats.screen_sharing.length === 0) return;
			...
			case "start_recording":
				...
				break;
			case "stop_recording":
				if (stats.recordings.length === 0) return;
